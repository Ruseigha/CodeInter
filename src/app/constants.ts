export const USER_PROGRAMS = [
  {
    ...
    workout_plan: {
      ...
      description:
        "A Computer Engineering student who excel in Data science and fullstck web development,he designed this progrma to fit into your lifestyle. It focuses on low-impact exercises to minimize strain on the lower back while promoting fat loss and improving cardiovascular fitness.",
    },
    diet_plan: {
